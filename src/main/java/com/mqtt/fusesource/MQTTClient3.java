...
public class MQTTClient3{
    ...
    public static final Logger LOG = LoggerFactory.getLogger(MQTTClient4.class);
    MQTT mqtt = null;
     ...
     mqtt= new MQTT();
		try {
			...
			mqtt.setHost(SEVER_STR);
			 //设置客户端唯一可识别的ID
			   mqtt.setClientId("460015214704243_P011000100013888");
			//连接前清空会话信息  
	...
	public static void main(String[] args) {
			 MQTTClient3 client = new MQTTClient3();
			 client.init();
			 client.subscribe();
	}
