...
public class MQTTClient2 {
	public static final String SEVER_STR = "tcp://10.247.53.154:1883";
	public static final short KEEP_ALIVE = 30;
	private final static boolean CLEAN_SESSION = false;  
	private final static int TIME_OUT = 1000;
    public static final Logger LOG = LoggerFactory.getLogger(MQTTServer.class);
    private static final String CLIENT_ID = "460015214704232_A011000100015387";
